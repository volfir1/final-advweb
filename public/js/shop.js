...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (key, value) {
                    ...
                    var item = `
                        <div class='menu-item' data-product-id='${value.id}'>
    ...
    function addEventListenersToItems() {
        ...
        // Add event listener for product clicks to display reviews
    ...
    function fetchAndDisplayReviews(productId) {
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                $('#reviewsModal .modal-body').empty(); // Clear previous reviews
                if (data.reviews && data.reviews.length > 0) {
                    data.reviews.forEach(review => {
                        $('#reviewsModal .modal-body').append(`
                    ...
                    $('#reviewsModal .modal-body').append('<p>No reviews available for this product.</p>');
                }
    ...
    function performSearch(query) {
        ...
        index.search(query).then(({ hits }) => {
            ...
            hits.forEach(hit => {
                ...
                var item = `
                    <div class='menu-item' data-product-id='${hit.id}'>
                        <div class='item-image'>
...
//         // Add event listener for product clicks to display reviews
//         $('.menu-item').off('click').on('click', function () {
//             const productId = $(this).find('.itemId').text();
//             fetchAndDisplayReviews(productId);
//         });
//     }
